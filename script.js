(() => {
  ...
  const AppData = {
    ...
    todayTasks: [
      ...
      },
      {
        id: 3,
        time: "14:30",
        title: "Kinesitherapie - Dr. Martin",
        done: false,
        important: true,
      },
      {
    ...
    recentActivity: [
      {
        ...
        icon: "check",
        color: "#9DBFA3",
        text: "Quiz du jour termine",
        sub: "Score: 7/10 - 9 min 32 sec",
        time: "10h42",
      },
      {
        id: 2,
        icon: "quiz",
        color: "#9DBFA3",
        text: "Question difficile: Qui est Sophie?",
        sub: "Quiz personnalise - Famille proche",
        time: "hier 15h",
      },
      {
        id: 3,
        icon: "check",
        color: "#9DBFA3",
        text: "Medicaments du matin pris",
        sub: "Tache marquee comme realisee",
        time: "hier 08h",
      },
      {
        id: 4,
        icon: "alert",
        color: "#E07840",
        text: "Rendez-vous Dr. Renaud non effectue",
        sub: "Mercredi 12 mars",
        time: "il y a 3j",
      },
      {
        id: 5,
        icon: "star",
        color: "#C4A882",
        text: "Anniversaire de Claude approche",
        sub: "Dans 4 jours",
        time: "il y a 4j",
      },
    ],
    ...
    quizList: [
      {
        ...
        played: 14,
        cover: "FAM",
        desc: "Questions sur les proches: Sophie, Claude...",
      },
      {
        id: 2,
      ...
      },
      {
        ...
        played: 7,
        cover: "HSE",
        desc: "Reconnaissance des pieces et objets du quotidien",
      },
      {
        id: 4,
    ...
    calendarEvents: [
      ...
      {
        id: 3,
        title: "Consultation neurologie",
        date: "2025-06-12",
        time: "10:00",
        lieu: "Hopital Pasteur, Nice",
        important: true,
        color: "#E07840",
        reminders: ["1j", "1h"],
      },
    ...
    insights: [
      {
        text: "Les quiz sur la famille proche obtiennent les meilleurs scores (+23% vs moyenne)",
        type: "green",
      },
      {
        text: "Le taux de bonnes reponses au premier essai est en baisse cette semaine (52% vs 64%)",
        type: "peach",
      },
      {
        text: "Les questions avec image sont mieux reussies que les questions textuelles (81% vs 58%)",
        type: "blue",
      },
      {
        text: "Jean utilise davantage les indices en apres-midi qu'en matinee",
        type: "peach",
      },
    ],
  };
  ...
  function barChartHTML(data, height = 150) {
    const max = Math.max(
      ...data.map((item) => Math.max(item.score, item.noHint)),
    );
    const cols = data
      .map((item) => {
  ...
  function mountSidebar(activePage, options = {}) {
    ...
    target.innerHTML = `
      <div class="brand-wrap">
        <div class="brand-row">
          <img class="brand-logo" src="${prefix}logo_kionokybo_red.png" alt="Kyonokibo logo">
          <div class="brand-copy">
            <div class="brand-name">yo<span>no</span>kibo</div>
